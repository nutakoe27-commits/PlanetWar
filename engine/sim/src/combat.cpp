...
constexpr HullStats kHulls[] = {
    ...
    // Колонизатор: ни одного оружейного слота, ни ПРО, ни ангаров.
    // Прочность нарочно мала — иначе он служил бы дешёвой бронёй,
    // а он гражданское судно, а не щит.
    {300,    0,  0, 0,  0},  // колонизатор
    {600,    4,  2, 2,  0},  // эсминец
